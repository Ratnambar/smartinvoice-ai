...
async def agent_validate_invoice(db: Annotated[Session, Depends(get_db)],
    ...
    #     "result": {
    #         "invoice": invoice,
    #         "invoice_id": agent_validated_data["invoice_id"],
    #         "vendor_id": agent_validated_data["vendor_id"],
    #         "vendor_name": agent_validated_data["vendor_name"],
    #         "check_message" : agent_validated_data["flags"]
    #     }
    # }
